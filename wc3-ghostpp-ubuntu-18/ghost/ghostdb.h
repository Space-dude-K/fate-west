...
class CCallableLobbySlotUpdate;
class CCallableLobbyDeleteAllLobbies;
class CCallableLobbyDeleteAllSlots;
class CCallableLobbyStatusUpdate;
class CCallableLobbyAdd;
class CCallableLobbySlotsInit;
...
public:
	...
	virtual bool LobbyAdd(uint32_t lobbyId, uint32_t m_HostCounter, string m_CreatorServer, string m_GameName, int lobbyStatus, string dateTime, int lobbyType);
	virtual bool LobbySlotsInit(uint32_t lobbyId, int slotId, int playerId, int playerTeam, string playerName, int playerColour, int playerPing);
	virtual bool LobbySlotUpdate(uint32_t lobbyId, uint32_t slotId, int playerId, int playerTeam, string playerName, int playerColour, int playerPing);
	virtual bool LobbyStatusUpdate(uint32_t lobbyId, int gameStatus, string dateTime);
	virtual bool LobbyDeleteAllLobbies();
	virtual bool LobbyDeleteAllSlots();
	...
	virtual CCallableLobbySlotUpdate *ThreadedLobbySlotUpdate(uint32_t nLobbyId, uint32_t nSlotId, int nPlayerId, int nPlayerTeam, string nPlayerName, int nPlayerColour, int nPlayerPing);
	virtual CCallableLobbyDeleteAllSlots* ThreadedLobbyDeleteAllSlots();
	virtual CCallableLobbyDeleteAllLobbies* ThreadedLobbyDeleteAllLobbies();
	virtual CCallableLobbyStatusUpdate *ThreadedLobbyStatusUpdate(uint32_t nLobbyId, int gameStatus, string dateTime);
	virtual CCallableLobbyAdd *ThreadedLobbyAdd(uint32_t lobbyId, uint32_t m_HostCounter, string m_CreatorServer, string m_GameName, int lobbyStatus, string dateTime, int lobbyType);
	virtual CCallableLobbySlotsInit *ThreadedLobbySlotsInit(uint32_t lobbyId, int slotId, int playerId, int playerTeam, string playerName, int playerColour, int playerPing);
...
class CCallableLobbySlotUpdate : virtual public CBaseCallable
{
protected:
	uint32_t m_LobbyId;
	uint32_t m_SlotId;
	...
	bool m_Result;
public:
	CCallableLobbySlotUpdate(uint32_t nLobbyId, uint32_t nSlotId, int nPlayerId, int nPlayerTeam, string nPlayerName, int nPlayerColour, int nPlayerPing) : CBaseCallable(), m_LobbyId(nLobbyId), m_SlotId(nSlotId), m_PlayerId(nPlayerId), m_PlayerTeam(nPlayerTeam), m_PlayerName(nPlayerName), m_PlayerColour(nPlayerColour), m_PlayerPing(nPlayerPing), m_Result(false) { }
	virtual ~CCallableLobbySlotUpdate( );

	virtual bool GetResult()				{ return m_Result; }
	virtual void SetResult(bool nResult)	{ m_Result = nResult; }
};
class CCallableLobbyDeleteAllLobbies : virtual public CBaseCallable
{
protected:
	bool m_Result;
public:
	CCallableLobbyDeleteAllLobbies() : CBaseCallable(), m_Result(false) { }
	virtual ~CCallableLobbyDeleteAllLobbies();

	virtual bool GetResult() { return m_Result; }
	virtual void SetResult(bool nResult) { m_Result = nResult; }
};
class CCallableLobbyDeleteAllSlots : virtual public CBaseCallable
{
protected:
	bool m_Result;
public:
	CCallableLobbyDeleteAllSlots() : CBaseCallable(), m_Result(false) { }
	virtual ~CCallableLobbyDeleteAllSlots();

	virtual bool GetResult() { return m_Result; }
	virtual void SetResult(bool nResult) { m_Result = nResult; }
};
class CCallableLobbyStatusUpdate : virtual public CBaseCallable
{
protected:
	uint32_t m_LobbyId;
	int m_GameStatus;
	...
	bool m_Result;
public:
	CCallableLobbyStatusUpdate(uint32_t nLobbyId, int nGameStatus, string nDateTime) : CBaseCallable(), m_LobbyId(nLobbyId), m_GameStatus(nGameStatus), m_DateTime(nDateTime),  m_Result(false) { }
	virtual ~CCallableLobbyStatusUpdate( );

	virtual bool GetResult() { return m_Result; }
	virtual void SetResult(bool nResult) { m_Result = nResult; }
};
class CCallableLobbyAdd : virtual public CBaseCallable
{
protected:
	uint32_t m_LobbyId;
	...
	bool m_Result;
public:
	CCallableLobbyAdd(uint32_t nLobbyId, uint32_t nHostCounter, string nCreatorServer, string nGameName, int nLobbyStatus, string nDateTime, int nLobbyType) 
		: CBaseCallable(), m_LobbyId(nLobbyId), m_HostCounter(nHostCounter), m_CreatorServer(nCreatorServer), m_GameName(nGameName), m_lobbyStatus(nLobbyStatus), m_dateTime(nDateTime), m_lobbyType(nLobbyType),
		m_Result(false) { }
	virtual ~CCallableLobbyAdd();

	virtual bool GetResult() { return m_Result; }
	virtual void SetResult(bool nResult) { m_Result = nResult; }
};
class CCallableLobbySlotsInit : virtual public CBaseCallable
{
protected:
	uint32_t m_LobbyId;
	int m_slotId;
	...
	bool m_Result;
public:
	CCallableLobbySlotsInit(uint32_t nLobbyId, int nSlotId, int nPlayerId, int nPlayerTeam, string nPlayerName, int nPlayerColour, int nPlayerPing)
		: CBaseCallable(), m_LobbyId(nLobbyId), m_slotId(nSlotId), m_PlayerId(nPlayerId), m_playerTeam(nPlayerTeam), m_PlayerName(nPlayerName), m_PlayerColour(nPlayerColour), m_PlayerPing(nPlayerPing),
		m_Result(false) { }
	virtual ~CCallableLobbySlotsInit();
