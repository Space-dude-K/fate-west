...
bool CGHostDB::LobbyAdd(uint32_t lobbyId, uint32_t m_HostCounter, string m_CreatorServer, string m_GameName, int lobbyStatus, string dateTime, int lobbyType)
{
	return 0;
}
bool CGHostDB::LobbySlotsInit(uint32_t lobbyId, int slotId, int playerId, int playerTeam, string playerName, int playerColour, int playerPing)
{
	return 0;
}
bool CGHostDB::LobbySlotUpdate(uint32_t lobbyId, uint32_t slotId, int playerId, int playerTeam, string playerName, int playerColour, int playerPing)
{
	return 0;
}
bool CGHostDB::LobbyStatusUpdate(uint32_t lobbyId, int gameStatus, string dateTime)
{
	return 0;
}
bool CGHostDB::LobbyDeleteAllLobbies()
{
	return 0;
}
bool CGHostDB::LobbyDeleteAllSlots()
{
	return 0;
}
...
CCallableLobbySlotUpdate *CGHostDB::ThreadedLobbySlotUpdate(uint32_t nLobbyId, uint32_t nSlotId, int nPlayerId, int nPlayerTeam, string nPlayerName, int nPlayerColour, int nPlayerPing)
{
	return NULL;
}
CCallableLobbyDeleteAllLobbies* CGHostDB::ThreadedLobbyDeleteAllLobbies()
{
	return NULL;
}
CCallableLobbyDeleteAllSlots* CGHostDB::ThreadedLobbyDeleteAllSlots()
{
	return NULL;
}
CCallableLobbyStatusUpdate *CGHostDB::ThreadedLobbyStatusUpdate(uint32_t nLobbyId, int gameStatus, string dateTime)
{
	return NULL;
}
CCallableLobbyAdd *CGHostDB::ThreadedLobbyAdd(uint32_t lobbyId, uint32_t m_HostCounter, string m_CreatorServer, string m_GameName, int lobbyStatus, string dateTime, int lobbyType)
{
	return NULL;
}
CCallableLobbySlotsInit* CGHostDB::ThreadedLobbySlotsInit(uint32_t lobbyId, int slotId, int playerId, int playerTeam, string playerName, int playerColour, int playerPing)
{
	return NULL;
}
...
CCallableLobbySlotUpdate :: ~CCallableLobbySlotUpdate()
{

}
CCallableLobbyAdd :: ~CCallableLobbyAdd()
{

}
CCallableLobbySlotsInit :: ~CCallableLobbySlotsInit()
{

}
CCallableLobbyStatusUpdate :: ~CCallableLobbyStatusUpdate()
{
...
CCallableLobbyDeleteAllLobbies::~CCallableLobbyDeleteAllLobbies()
{
}

CCallableLobbyDeleteAllSlots::~CCallableLobbyDeleteAllSlots()
{
}
