...
public:
	...
	virtual CCallableLobbySlotsInit* ThreadedLobbySlotsInit(uint32_t nLobbyId, int nSlotId, int nPlayerId, int nPlayerTeam, string nPlayerName, int nPlayerColour, int nPlayerPing);
